<div class="row">
                <div class="col-md-12">
                   <center> <h4 class="page-head-line">Selamat Datang Di Sistem Perpustakaan SMK Widya Dirgantara</h4></center>
                </div>
...
<div class="row">
                ...
                <div class="col-md-6">
                      <div class="notice-board">
                        <div class="panel panel-info">
                        <div class="panel-heading">
                            Perpustakaan SMK Widya Dirgantara 
                        </div>
                                <div class="panel-body">
                                <ul align="justify">
                                Untuk mendukung kelancaran proses beajar-mengajar dan meningkatkan kualitas pendidikan siswa di SMK Pembangunan telah menyediakan beragam buku dengan beragam kategori yang dapat dimanfaatkan siswa
