...
<body>
        ...
        <div class="container">
            <div class="left-div">
                <div class="user-settings-wrapper">
                    <ul class="nav">
                    <center><font color="white"><h1><B>SISTEM PERPUSTAKAAN SMK WIDYA DIRGANTARA</B></h1></font></center>   
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    Published 2020 By : <a href="https://www.sarjanakomedi.com/" target="_blank">SMK Widya Dirganatara</a>
                </div>
