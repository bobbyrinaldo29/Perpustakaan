...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url(); ?>admin/Kelas"><i class="fa fa-folder"></i>Data Kelas</a></li>
             <!--<li><a href="<?php echo base_url(); ?>admin/Agama"><i class="fa fa-moon-o"></i>Data Agama</a></li>-->
             <!--<li><a href="<?php echo base_url(); ?>admin/Anggota"><i class="fa fa-file"></i>Kartu Anggota</a></li>-->
          </ul>
        </li>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Published 2020 by <a href="https://www.sarjanakomedi.com">SMK Widya Dirgantara</a>.</strong> 
  </footer>
